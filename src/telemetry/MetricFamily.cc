...
MetricFamily::MetricFamily(std::string_view prefix, std::string_view name,
                           Span<const std::string_view> lbls, std::string_view helptext,
...
RecordValPtr MetricFamily::GetMetricOptsRecord() const
	...
	record_val->Assign(metric_type_idx,
	                   zeek::BifType::Enum::Telemetry::MetricType->GetEnumVal(MetricType()));
...
bool MetricFamily::Matches(std::string_view prefix_pattern,
                           std::string_view name_pattern) const noexcept
	{
